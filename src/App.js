...
function App() {
  ...
  const countDownDate = new Date("Nov 17 2023 15:11:56").getTime()
  ...
  return (
    <div className="App">
        <main className="container">
          <h1>my next (2023) birthday 🥳</h1>
          <div className="cards">
            <div className="days">
              <div>
                {days < 10 ? <p className="figures">0{days}</p> : <p className="figures">{days}</p>}
              </div>
              <p>days</p>
            </div>
            <div className="hours">
              <div>
                {hours < 10 ? <p className="figures">0{hours}</p> : <p className="figures">{hours}</p>}
              </div>
              <p>hours</p>
            </div>
            <div className="minutes">
              <div>
                {minutes < 10 ? <p className="figures">0{minutes}</p> : <p className="figures">{minutes}</p>}
              </div>
              <p>minutes</p>
            </div>
            <div className="seconds">
              <div>
                {seconds < 10 ? <p className="figures">0{seconds}</p> : <p className="figures">{seconds}</p>}
              </div>
              <p>seconds</p>
            </div>
          </div>
        ...
        <footer>
          <div>
            <a href="https://www.facebook.com/profile.php?id=100005064465676" target="_blank" rel="noreferrer">
              <button>
            ...
            <a href="https://www.pinterest.com/nwochachioma/" target="_blank" rel="noreferrer">
              <button>
            ...
            <a href="https://www.instagram.com/nwocha_/" target="_blank" rel="noreferrer">
              <button>
          ...
          <a href="https://www.frontendmentor.io/challenges/launch-countdown-timer-N0XkGfyz-/hub" target="_blank" rel="noreferrer"><p>a frontend-mentor challenge</p></a>
        </footer>
